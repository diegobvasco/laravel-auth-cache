...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/diegobvasco/laravel-auth-cache/unit-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/diegobvasco/laravel-auth-cache/actions?query=workflow%3Aunit-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/diegobvasco/laravel-auth-cache/format-tests.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/diegobvasco/laravel-auth-cache/actions?query=workflow%3A"Format+tests"+branch%3Amain)
